                ...
                <div class="card-body">
                    <form method="post">
                        <div class="input-group form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Mobile" required name="email">
                        ...
                        <div class="form-group">
                            <a href="../index.php" class="btn float-left login_btn">Home </a>
...
session_start();
   include('inc/db.php');
       ...
       if (isset($_POST['login'])){
        ...
        $get_user = "SELECT * FROM users where user_mobile = '$email' AND user_pass = '$pass'";
